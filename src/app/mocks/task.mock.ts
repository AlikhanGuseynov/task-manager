...
export const TaskMock: Task[] = [
  {
    ...
    creator: UserMock[0],
    performer: [UserMock[1], UserMock[2], UserMock[3]],
  },
  {
    id: 2,
    companyId: 123,
    ...
    creator: UserMock[2],
    performer: [UserMock[1], UserMock[3]],
  },
  {
    id: 3,
    companyId: 987,
    ...
    creator: UserMock[0],
    performer: [UserMock[1], UserMock[2]],
  },
  {
    id: 4,
    companyId: 123,
    ...
    creator: UserMock[1],
    performer: [UserMock[2], UserMock[3]],
  },
  {
    id: 5,
    companyId: 123,
